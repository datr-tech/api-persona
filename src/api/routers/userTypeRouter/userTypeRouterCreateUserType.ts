...
import {
  IUserTypeControllerCreateUserTypeOutputError as IControllerError,
  IUserTypeControllerCreateUserTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					userTypeRouterCreateUserType
 *
 * @description		The 'createUserType' router for 'userType', whose expected
 *                inputs have been defined within the following schema:
 *                'userTypeValidationSchemaCreateUserType'.
 *
...
export const userTypeRouterCreateUserType = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'userTypeValidationSchemaCreateUserType'.
      ...
      const stat = await userTypeController.createUserType(validatedParams);
