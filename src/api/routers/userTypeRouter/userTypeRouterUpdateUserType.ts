...
import {
  IUserTypeControllerUpdateUserTypeOutputError as IControllerError,
  IUserTypeControllerUpdateUserTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					userTypeRouterUpdateUserType
 *
 * @description		The 'updateUserType' router for 'userType', whose expected
 *                inputs have been defined within the following schema:
 *                'userTypeValidationSchemaUpdateUserType'.
 *
...
export const userTypeRouterUpdateUserType = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'userTypeValidationSchemaUpdateUserType'.
      ...
      const stat = await userTypeController.updateUserType({ userTypeId, payload });
       ...
       * 'userTypeId' from 'stat.payload' and return
      ...
      res
        ...
        .send({ userTypeId: controllerResponsePayload['userTypeId'] });
    } catch (error) {
      /*
