...
import {
  IUserControllerCreateUserOutputError as IControllerError,
  IUserControllerCreateUserOutputSuccess as IControllerSuccess,
...
/**
 * @name					userRouterCreateUser
 *
 * @description		The 'createUser' router for 'user', whose expected
 *                inputs have been defined within the following schema:
 *                'userValidationSchemaCreateUser'.
 *
...
export const userRouterCreateUser = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'userValidationSchemaCreateUser'.
      ...
      const stat = await userController.createUser(validatedParams);
