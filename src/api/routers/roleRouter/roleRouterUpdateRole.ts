...
import {
  IRoleControllerUpdateRoleOutputError as IControllerError,
  IRoleControllerUpdateRoleOutputSuccess as IControllerSuccess,
...
/**
 * @name					roleRouterUpdateRole
 *
 * @description		The 'updateRole' router for 'role', whose expected
 *                inputs have been defined within the following schema:
 *                'roleValidationSchemaUpdateRole'.
 *
...
export const roleRouterUpdateRole = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'roleValidationSchemaUpdateRole'.
      ...
      const stat = await roleController.updateRole({ roleId, payload });
