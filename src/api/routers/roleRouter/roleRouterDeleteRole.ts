...
import {
  IRoleControllerDeleteRoleOutputError as IControllerError,
  IRoleControllerDeleteRoleOutputSuccess as IControllerSuccess,
...
/**
 * @name					roleRouterDeleteRole
 *
 * @description		The 'deleteRole' router for 'role', whose expected
 *                inputs have been defined within the following schema:
 *                'roleValidationSchemaDeleteRole'.
 *
 ...
 *                | Server error                | 500               |
 */
export const roleRouterDeleteRole = Router(options).delete(
  '/',
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'roleValidationSchemaDeleteRole'.
      ...
      const stat = await roleController.deleteRole(validatedParams);
       ...
       * 'roleId' from 'stat.payload' and return
      ...
      res
        ...
        .send({ roleId: controllerResponsePayload['roleId'] });
    } catch (error) {
      /*
