...
import {
  IRoleControllerCreateRoleOutputError as IControllerError,
  IRoleControllerCreateRoleOutputSuccess as IControllerSuccess,
...
/**
 * @name					roleRouterCreateRole
 *
 * @description		The 'createRole' router for 'role', whose expected
 *                inputs have been defined within the following schema:
 *                'roleValidationSchemaCreateRole'.
 *
...
export const roleRouterCreateRole = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'roleValidationSchemaCreateRole'.
      ...
      const stat = await roleController.createRole(validatedParams);
