...
import {
  IOrganisationUserControllerUpdateOrganisationUserOutputError as IControllerError,
  IOrganisationUserControllerUpdateOrganisationUserOutputSuccess as IControllerSuccess,
...
/**
 * @name					organisationUserRouterUpdateOrganisationUser
 *
 * @description		The 'updateOrganisationUser' router for 'organisationUser', whose expected
 *                inputs have been defined within the following schema:
 *                'organisationUserValidationSchemaUpdateOrganisationUser'.
 *
...
export const organisationUserRouterUpdateOrganisationUser = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'organisationUserValidationSchemaUpdateOrganisationUser'.
      ...
      const stat = await organisationUserController.updateOrganisationUser({
        organisationUserId,
        payload,
      });
