...
import {
  IOrganisationUserControllerDeleteOrganisationUserOutputError as IControllerError,
  IOrganisationUserControllerDeleteOrganisationUserOutputSuccess as IControllerSuccess,
...
/**
 * @name					organisationUserRouterDeleteOrganisationUser
 *
 * @description		The 'deleteOrganisationUser' router for 'organisationUser', whose expected
 *                inputs have been defined within the following schema:
 *                'organisationUserValidationSchemaDeleteOrganisationUser'.
 *
 ...
 *                | Server error                | 500               |
 */
export const organisationUserRouterDeleteOrganisationUser = Router(options).delete(
  '/',
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'organisationUserValidationSchemaDeleteOrganisationUser'.
      ...
      const stat =
        await organisationUserController.deleteOrganisationUser(validatedParams);
       ...
       * 'organisationUserId' from 'stat.payload' and return
      ...
      res
        ...
        .send({ organisationUserId: controllerResponsePayload['organisationUserId'] });
    } catch (error) {
      /*
