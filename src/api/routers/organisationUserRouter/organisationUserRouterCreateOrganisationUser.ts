...
import {
  IOrganisationUserControllerCreateOrganisationUserOutputError as IControllerError,
  IOrganisationUserControllerCreateOrganisationUserOutputSuccess as IControllerSuccess,
...
/**
 * @name					organisationUserRouterCreateOrganisationUser
 *
 * @description		The 'createOrganisationUser' router for 'organisationUser', whose expected
 *                inputs have been defined within the following schema:
 *                'organisationUserValidationSchemaCreateOrganisationUser'.
 *
...
export const organisationUserRouterCreateOrganisationUser = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'organisationUserValidationSchemaCreateOrganisationUser'.
