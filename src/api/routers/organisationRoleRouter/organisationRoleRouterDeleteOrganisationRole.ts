...
import {
  IOrganisationRoleControllerDeleteOrganisationRoleOutputError as IControllerError,
  IOrganisationRoleControllerDeleteOrganisationRoleOutputSuccess as IControllerSuccess,
...
/**
 * @name					organisationRoleRouterDeleteOrganisationRole
 *
 * @description		The 'deleteOrganisationRole' router for 'organisationRole', whose expected
 *                inputs have been defined within the following schema:
 *                'organisationRoleValidationSchemaDeleteOrganisationRole'.
 *
 ...
 *                | Server error                | 500               |
 */
export const organisationRoleRouterDeleteOrganisationRole = Router(options).delete(
  '/',
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'organisationRoleValidationSchemaDeleteOrganisationRole'.
      ...
      const stat =
        await organisationRoleController.deleteOrganisationRole(validatedParams);
