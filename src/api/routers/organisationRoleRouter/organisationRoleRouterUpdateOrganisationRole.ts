...
import {
  IOrganisationRoleControllerUpdateOrganisationRoleOutputError as IControllerError,
  IOrganisationRoleControllerUpdateOrganisationRoleOutputSuccess as IControllerSuccess,
...
/**
 * @name					organisationRoleRouterUpdateOrganisationRole
 *
 * @description		The 'updateOrganisationRole' router for 'organisationRole', whose expected
 *                inputs have been defined within the following schema:
 *                'organisationRoleValidationSchemaUpdateOrganisationRole'.
 *
...
export const organisationRoleRouterUpdateOrganisationRole = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'organisationRoleValidationSchemaUpdateOrganisationRole'.
      ...
      const stat = await organisationRoleController.updateOrganisationRole({
        organisationRoleId,
        payload,
      });
