...
import {
  IOrganisationTypeControllerCreateOrganisationTypeOutputError as IControllerError,
  IOrganisationTypeControllerCreateOrganisationTypeOutputSuccess as IControllerSuccess,
...
/**
 * @name					organisationTypeRouterCreateOrganisationType
 *
 * @description		The 'createOrganisationType' router for 'organisationType', whose expected
 *                inputs have been defined within the following schema:
 *                'organisationTypeValidationSchemaCreateOrganisationType'.
 *
...
export const organisationTypeRouterCreateOrganisationType = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'organisationTypeValidationSchemaCreateOrganisationType'.
