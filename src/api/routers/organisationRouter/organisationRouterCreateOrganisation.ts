...
import {
  IOrganisationControllerCreateOrganisationOutputError as IControllerError,
  IOrganisationControllerCreateOrganisationOutputSuccess as IControllerSuccess,
...
/**
 * @name					organisationRouterCreateOrganisation
 *
 * @description		The 'createOrganisation' router for 'organisation', whose expected
 *                inputs have been defined within the following schema:
 *                'organisationValidationSchemaCreateOrganisation'.
 *
...
export const organisationRouterCreateOrganisation = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'organisationValidationSchemaCreateOrganisation'.
      ...
      const stat = await organisationController.createOrganisation(validatedParams);
