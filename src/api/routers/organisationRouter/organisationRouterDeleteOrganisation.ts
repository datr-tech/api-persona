...
import {
  IOrganisationControllerDeleteOrganisationOutputError as IControllerError,
  IOrganisationControllerDeleteOrganisationOutputSuccess as IControllerSuccess,
...
/**
 * @name					organisationRouterDeleteOrganisation
 *
 * @description		The 'deleteOrganisation' router for 'organisation', whose expected
 *                inputs have been defined within the following schema:
 *                'organisationValidationSchemaDeleteOrganisation'.
 *
 ...
 *                | Server error                | 500               |
 */
export const organisationRouterDeleteOrganisation = Router(options).delete(
  '/',
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'organisationValidationSchemaDeleteOrganisation'.
      ...
      const stat = await organisationController.deleteOrganisation(validatedParams);
       ...
       * 'organisationId' from 'stat.payload' and return
      ...
      res
        ...
        .send({ organisationId: controllerResponsePayload['organisationId'] });
    } catch (error) {
      /*
