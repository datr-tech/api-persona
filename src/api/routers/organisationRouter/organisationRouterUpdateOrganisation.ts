...
import {
  IOrganisationControllerUpdateOrganisationOutputError as IControllerError,
  IOrganisationControllerUpdateOrganisationOutputSuccess as IControllerSuccess,
...
/**
 * @name					organisationRouterUpdateOrganisation
 *
 * @description		The 'updateOrganisation' router for 'organisation', whose expected
 *                inputs have been defined within the following schema:
 *                'organisationValidationSchemaUpdateOrganisation'.
 *
...
export const organisationRouterUpdateOrganisation = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'organisationValidationSchemaUpdateOrganisation'.
      ...
      const stat = await organisationController.updateOrganisation({
        organisationId,
        payload,
      });
