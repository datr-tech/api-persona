...
import {
  IUserSessionControllerCreateUserSessionOutputError as IControllerError,
  IUserSessionControllerCreateUserSessionOutputSuccess as IControllerSuccess,
...
/**
 * @name					userSessionRouterCreateUserSession
 *
 * @description		The 'createUserSession' router for 'userSession', whose expected
 *                inputs have been defined within the following schema:
 *                'userSessionValidationSchemaCreateUserSession'.
 *
...
export const userSessionRouterCreateUserSession = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'userSessionValidationSchemaCreateUserSession'.
      ...
      const stat = await userSessionController.createUserSession(validatedParams);
