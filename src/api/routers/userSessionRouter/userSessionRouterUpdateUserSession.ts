...
import {
  IUserSessionControllerUpdateUserSessionOutputError as IControllerError,
  IUserSessionControllerUpdateUserSessionOutputSuccess as IControllerSuccess,
...
/**
 * @name					userSessionRouterUpdateUserSession
 *
 * @description		The 'updateUserSession' router for 'userSession', whose expected
 *                inputs have been defined within the following schema:
 *                'userSessionValidationSchemaUpdateUserSession'.
 *
...
export const userSessionRouterUpdateUserSession = Router(options).patch(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'userSessionValidationSchemaUpdateUserSession'.
      ...
      const stat = await userSessionController.updateUserSession({
        userSessionId,
        payload,
      });
